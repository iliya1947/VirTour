    ...
    <main className="pb-20">
      ...
      <section className="mx-auto mt-16 w-[94%] max-w-7xl space-y-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {featuredListings.map((listing) => (
            <article key={listing.title} className="group relative overflow-hidden rounded-3xl border border-white/10 bg-ink/70 shadow-glow transition duration-500 hover:-translate-y-1 hover:scale-[1.015]">
      ...
      <section className="mx-auto mt-20 w-[94%] max-w-7xl">
        <div className="grid gap-5 md:grid-cols-3">
          {['Verified agents', 'Secure communication', 'Immersive viewing'].map((item) => (
