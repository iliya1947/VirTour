  ...
  return (
    <main className="pb-16">
      <section className="relative min-h-[82vh]">
        ...
        <div className="relative"><div className="mx-auto flex min-h-[72vh] w-[94%] max-w-7xl items-end pb-14"><div className="max-w-3xl space-y-5"><p className="text-sm uppercase tracking-[0.24em] text-cyan-200/90">{t('homepage', 'hero.eyebrow')}</p><h1 className="text-4xl font-semibold leading-tight md:text-6xl">{t('homepage', 'hero.title')}</h1><p className="max-w-2xl text-base text-white/80 md:text-xl">{t('homepage', 'hero.subtitle')}</p></div></div></div>
      </section>
      ...
      <section id="featured" className="mx-auto mt-10 w-[94%] max-w-7xl space-y-8">
